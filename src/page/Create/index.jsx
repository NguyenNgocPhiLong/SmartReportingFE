...
const CreateUser = () => {
    ...
    const handleNewResource = async (e) => {
        await axios
            .post(`${BaseURL.url}/resources`, formData, {
                headers: {
            ...
            .then(function (response) {
                ...
                navigator('/'); // Điều hướng người dùng về trang resource sau khi tạo thành công
            })
    ...
    const handleSubmit = (e) => {
        ...
        handleNewResource(); // Gọi hàm tạo mới resource nếu form hợp lệ
